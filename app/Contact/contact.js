        ...
        <div>
          <div >
            <form className='flex flex-col  my-10 mx-[5vw]' action="">
              ...
              <textarea ref={ref} onChange={(e) => { setMessage(e.target.value) }} className='text-[#9a99ff] placeholder:text-[#9a99ff] pb-8 h-[40vh] text-xl  border border-[#424242] rounded my-2' name="message" placeholder='_message*' id="" ></textarea>
            </form>
          </div>
        </div>
