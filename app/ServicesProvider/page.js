        ...
        <section>
          <div className='mt-[10vh]'>
            <div className='flex'>
              ...
              <div className='w-[55vw] text-[#cac068] text-lg p-3 border border-[#3c3c3c]'>Frontend development focuses on creating user-friendly interfaces with HTML, CSS, and JavaScript. It emphasizes responsive design, usability, and aesthetics, ensuring a seamless and engaging user experience across devices.</div>
            </div>
            <div className='flex'>
              <div className='flex justify-around items-center w-[45vw] border border-[#3c3c3c]'>
              ...
              <div className='w-[55vw] text-[#cac068] text-lg p-3 border border-[#3c3c3c]'>Backend development involves server-side programming, databases, and APIs. It ensures data processing, storage, and security, providing the essential infrastructure that supports and powers the functionality of web applications.</div>
              ...
              <div className='w-[55vw] text-[#cac068] text-lg p-3 border border-[#3c3c3c]'>Fullstack development integrates frontend and backend skills, enabling the creation of complete web applications. Fullstack developers manage everything from user interfaces to server logic, ensuring seamless functionality and optimal performance.</div>
            </div>
          </div>
        </section>
      </main>
