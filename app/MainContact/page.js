    ...
    <>
      <main>
        ...
        <div className='w-[80vw] sm:w-[60vw] flex mx-auto flex-col justify-center items-center'>
          ...
          <div className='text-white mt-5 w-[80vw] sm:w-[50vw] text-cente'>
        ...
        <div className='sm:flex my-[5vh]'>
          <div className='border border-[#3c3c3c] w-[80vw] mx-auto sm:w-[30vw] text-center p-5 text-2xl flex flex-col'>
            ...
            <div className='text-white hover:text-[#4baed8]'>+91-75350-05331</div>
          </div>
          <div className='border border-[#3c3c3c] w-[80vw] mx-auto sm:w-[30vw] text-center p-5 text-2xl flex flex-col'>
            <div className='text-[#cac068] '>_email</div>
            <div className='text-white hover:text-[#4baed8]'><Link href="">codngwthubaid@gmail.com</Link></div>
          </div>
          <div className='border border-[#3c3c3c] w-[80vw] mx-auto sm:w-[30vw] text-center p-5 text-2xl flex flex-col'>
            <div className='text-[#cac068] '>_address</div>
            <div className='text-white hover:text-[#4baed8]'>Rampur, UP, India</div>
          </div>
        </div>
      </main>
    </>
