            ...
            <header>
                ...
                {isClick && (
                    <div className='lg:hidden'>
                        <ul className='flex flex-col h-fit md:flex-row justify-evenly text-xl md:h-[10vw] items-start w-full bg-[#302f2f] rounded-xl px-[10vw]'>
                            <li className='hover:text-[#9a99ff] bg-[#302f2f]'>
                                <Link className='bg-[#302f2f]' href="/">_home</Link>
                            </li>
                            <li className='hover:text-[#9a99ff] bg-[#302f2f]'>
                                <Link className='bg-[#302f2f]' href="/About">_about</Link>
                            </li>
                            <li className='hover:text-[#9a99ff] bg-[#302f2f]'>
                                <Link className='bg-[#302f2f]' href="/Portfolio">_portfolio</Link>
                            </li>

                            <li className='hover:text-[#9a99ff] bg-[#302f2f]'>
                                <Link className='bg-[#302f2f]' href="/ServicesProvider">_services</Link>
                            </li>
                            <li className='hover:text-[#9a99ff] bg-[#302f2f]'>
                                <Link className='bg-[#302f2f]' href="/Resume">_resume</Link>
                            </li>
                            <li className='hover:text-[#9a99ff] bg-[#302f2f]'>
                                <Link className='bg-[#302f2f]' href="/MainContact">_contact</Link>
                            </li>
                        </ul>
                    </div>
                )}
